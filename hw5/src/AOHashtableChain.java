...
public class AOHashtableChain<K,V> implements AOHashMap<K, V>{
    /** The table */
     ...
     */
    public void rehash(){
        LinkedList<Entry<K, V>>[] tmp= new LinkedList[table.length*2+1];
        for(int i=0;i< table.length;i++){
            tmp[i]=table[i];
        }
        table=new LinkedList[tmp.length];
        Iterator iter;
        numKeys=0;
