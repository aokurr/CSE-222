public class chairs implements furniture  {
    ...
    public chairs(int color_entry,int model_entry)throws ahmets_exceptions{
        if(color_entry<1 || color_entry>6){
            throw new ahmets_exceptions("Incorrect color id. it should be color>0 && color<6");
        }
        color=color_entry;
